...
export const SITE_IMAGES = {
  ...
  "section-faq-community": {
    alt: "Q&A notebook, glasses, and aerial print of Rhodes Ranch golf-course homes in Las Vegas 89148",
    width: 1152,
    height: 864,
    heading: "Rhodes Ranch FAQ",
  },
  "section-buyer-faq": {
    alt: "Buyer FAQ notebook, keys, and a Rhodes Ranch Las Vegas home listing on a tablet",
    width: 1152,
    height: 864,
    heading: "Buyer FAQ",
  },
  "section-buyer-journey": {
    alt: "Four-step Rhodes Ranch buyer journey: pre-approval, search, showing, and closing documents",
    width: 1152,
    height: 864,
    heading: "Your Buyer Journey (Overview)",
  },
  "section-golf-commute": {
    alt: "Golf fairway, walking path, and Las Vegas valley roads from Rhodes Ranch in 89148",
    width: 1152,
    height: 864,
    heading: "Explore golf, recreation, and commute before you offer",
  },
  "section-new-listings-faq": {
    alt: "Newly listed southwest Las Vegas home photo with a NEW tag and Q&A notebook",
    width: 1152,
    height: 864,
    heading: "New Rhodes Ranch listings FAQ",
  },
  "section-weekday-faq": {
    alt: "Weekday open-house planner, keys, and southwest Las Vegas golf-community map",
    width: 1152,
    height: 864,
    heading: "Open house FAQ by weekday",
  },
  "section-pool-faq": {
    alt: "Q&A notebook and sunglasses beside a Rhodes Ranch Las Vegas backyard pool photo",
    width: 1152,
    height: 864,
    heading: "Rhodes Ranch pool homes FAQ",
  },
  "section-price-faq": {
    alt: "Modest southwest Las Vegas home photo, calculator, and 89148 map for a price-band FAQ",
    width: 1152,
    height: 864,
    heading: "Homes under $500k FAQ",
  },
  "section-contact-faq": {
    alt: "Office phone, weekly schedule card, keys, and 7272 S El Capitan Way note for contact FAQ",
    width: 1152,
    height: 864,
    heading: "Questions about scheduling and contact",
  },
  "section-qa-answers": {
    alt: "Question and answer notebooks with a Rhodes Ranch Las Vegas golf-community aerial print",
    width: 1152,
    height: 864,
    heading: "Questions and answers",
  },
  "section-watch-community": {
    alt: "Guard-gated entrance opening onto golf fairways and tile-roof homes in Rhodes Ranch Las Vegas",
    width: 1152,
    height: 864,
    heading: "Why Buyers Watch Rhodes Ranch",
  },
  "og-share": {
